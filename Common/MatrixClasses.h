...
public:
  ...
  C4API Matrix3D(float n00, float n01, float n02, float n10, float n11,
                 float n12, float n20, float n21, float n22);

  C4API Matrix3D &Set(const Vector3D &c1, const Vector3D &c2,
                      const Vector3D &c3);
  C4API Matrix3D &Set(float n00, float n01, float n02, float n10, float n11,
                      float n12, float n20, float n21, float n22);

  float &operator()(long i, long j) { return (n[j][i]); }

  const float &operator()(long i, long j) const { return (n[j][i]); }

  Vector3D &operator[](long j) { return (*reinterpret_cast<Vector3D *>(n[j])); }
...
inline Matrix3D operator*(float t, const Matrix3D &m) { return (m * t); }
...
public:
  ...
  Matrix4D(const Vector4D &c1, const Vector4D &c2, const Vector4D &c3,
           const Vector4D &c4);
  Matrix4D(float n00, float n01, float n02, float n03, float n10, float n11,
  ...
  Vector4D &operator[](long j) { return (*reinterpret_cast<Vector4D *>(n[j])); }
